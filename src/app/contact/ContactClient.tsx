    ...
    <div className="min-h-screen bg-nyme-bg pt-20 sm:pt-28 pb-16">
      ...
      <div className="section-hero relative overflow-hidden py-12 sm:py-16 mb-10 sm:mb-14">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white/80 text-xs sm:text-sm font-medium mb-5 font-body">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 mt-6 px-5 py-3 rounded-xl bg-nyme-green/20 border border-nyme-green/40 text-nyme-green font-semibold text-sm hover:bg-nyme-green hover:text-white transition-all duration-300 font-body"
          >
            💬 Écrire sur WhatsApp
          </a>
        </div>
          ...
          {cards.map(({ icon: Icon, title, content, sub, href, accent }) => (
            <a key={title} href={href} className={`card border-l-4 ${accent} p-3 sm:p-4 flex items-start gap-2.5`}>
              ...
              <div className="min-w-0">
                <div className="text-nyme-text-muted text-[9px] sm:text-xs uppercase tracking-wider mb-0.5 font-body">{title}</div>
                <div className="text-nyme-text font-semibold text-[11px] sm:text-xs truncate font-body">{content}</div>
          ...
          <div className="hidden lg:block lg:col-span-1 space-y-3">
            {cards.map(({ icon: Icon, title, content, sub, href, accent }) => (
              <a key={title} href={href} className={`card border-l-4 ${accent} p-5 flex items-start gap-4 hover:scale-[1.02]`}>
                ...
                <div>
                  <div className="text-nyme-text-muted text-xs uppercase tracking-wider mb-0.5 font-body">{title}</div>
                  <div className="text-nyme-text font-semibold text-sm font-body">{content}</div>
            ...
            <div id="partenaires" className="card p-5 border-t-4 border-t-nyme-orange">
              ...
              <p className="text-nyme-text-muted text-xs leading-relaxed mb-3 font-body">
                Boutique ou entreprise à Ouagadougou ? Intégrez NYME dans votre logistique avec un abonnement mensuel.
              </p>
              <a href="/partenaires" className="text-nyme-orange text-xs font-semibold hover:underline font-body">
            ...
            <div className="card p-5 sm:p-8">
              {sent ? (
                <div className="text-center py-10 sm:py-14">
                  ...
                  <p className="text-nyme-text-muted text-sm font-body">Merci. L'équipe NYME vous répondra sous 24h à <strong>nyme.contact@gmail.com</strong>.</p>
                  <div className="flex flex-col sm:flex-row justify-center gap-3 mt-6">
                    ...
                    <a
                      ...
                      target="_blank" rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 py-2.5 px-5 rounded-xl bg-nyme-green/10 border border-nyme-green/20 text-nyme-green text-sm font-semibold hover:bg-nyme-green hover:text-white transition-all font-body"
                    >
                      💬 WhatsApp
                    </a>
                  </div>
                ...
                <>
                  ...
                  <p className="text-nyme-text-muted text-xs mb-5 sm:mb-6 font-body">
                    Ou écrivez-nous directement à{' '}
                    <a href="mailto:nyme.contact@gmail.com" className="text-nyme-orange hover:underline">nyme.contact@gmail.com</a>
                  </p>

                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-nyme-text-muted text-xs uppercase tracking-wider font-medium mb-1.5 font-body">Nom complet *</label>
                    ...
                    <div>
                      <label className="block text-nyme-text-muted text-xs uppercase tracking-wider font-medium mb-1.5 font-body">Sujet *</label>
                    ...
                    <div>
                      <label className="block text-nyme-text-muted text-xs uppercase tracking-wider font-medium mb-1.5 font-body">Message *</label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      <a
                        ...
                        target="_blank" rel="noopener noreferrer"
                        className="flex items-center justify-center gap-2 py-3.5 rounded-xl bg-nyme-green/10 border border-nyme-green/20 text-nyme-green font-semibold text-sm hover:bg-nyme-green hover:text-white transition-all font-body"
                      >
                        💬 WhatsApp
                      </a>
                    </div>
