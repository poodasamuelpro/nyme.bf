      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-nyme-blue-light/20 mb-6">
            <span className="text-nyme-blue-light text-sm">🔒 Vos données, votre vie privée</span>
          </div>
        ...
        <div className="prose-nyme space-y-10">
...
Nous ne vendons jamais vos données personnelles à des tiers à des fins commerciales.`
            ...
            {
              id: 'gps',
              title: '4. Données de localisation GPS',
...
Pour exercer vos droits, contactez-nous à privacy@nyme.app ou via le formulaire de contact. Nous traitons les demandes sous 30 jours.`
            },
            {
              id: 'cookies',
              title: '9. Cookies & technologies similaires',
...
Vous pouvez désactiver les cookies non essentiels dans les paramètres de votre navigateur.`
            },
            {
              ...
              content: `NYME n'est pas destiné aux personnes de moins de 18 ans. Nous ne collectons pas sciemment de données personnelles d'enfants. Si vous pensez qu'un mineur a créé un compte, contactez-nous immédiatement à privacy@nyme.app pour suppression.`
            },
            {
              id: 'modifications',
...
Si vous estimez que vos droits n'ont pas été respectés, vous pouvez déposer une réclamation auprès des autorités de protection des données compétentes au Burkina Faso.`
            ...
            <div key={section.id} id={section.id} className="glass rounded-2xl p-8 border border-white/10">
              ...
              <div className="text-white/60 font-body text-sm leading-relaxed space-y-3 whitespace-pre-line">
