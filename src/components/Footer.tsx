      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-white/65 text-sm font-body leading-relaxed mb-5 max-w-xs">
              La plateforme de livraison intelligente conçue pour l'Afrique de l'Ouest. Rapide, sécurisée, accessible à tous.
            </p>
            ...
            <div className="space-y-2.5">
              ...
              <a href="tel:+22677980264" className="flex items-center gap-2.5 text-white/65 text-sm hover:text-white transition-colors font-body">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                ['/partenaires/login',  'Espace Partenaires'],
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/40 text-xs font-body">Application en cours de déploiement</span>
          </div>
        </div>
      </div>
    </footer>
